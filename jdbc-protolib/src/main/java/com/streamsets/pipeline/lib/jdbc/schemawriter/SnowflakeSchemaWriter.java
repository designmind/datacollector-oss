...
public class SnowflakeSchemaWriter extends JdbcAbstractSchemaWriter {
    private static final Map<JdbcType, String> jdbcTypeToName = ImmutableMap.<JdbcType, String>builder()
        ...
        .put(JdbcType.TIMESTAMP, "timestamp_ntz")
        .put(JdbcType.TIMESTAMP_WITH_TIME_ZONE, "timestamp_tz")
    ...
    public SnowflakeSchemaWriter(HikariDataSource dataSource) {
        super(dataSource);
    }
